<template>
  <footer class="max-w-screen-xl px-8 mx-auto">
    ...
    <div class="py-8 sm:py-4 text-center text-sm text-[#666666] hover:text-gray-900">
      &copy; Copyright 2022 NEFA LLC. All rights reserved by <a class="font-semibold hover:text-green-600" href="https://github.com/RSurya99" target="_blank">Rafli Surya P</a>
      <p> Distributed by <a class="font-semibold hover:text-green-600" href="https://themewagon.com/" target="_blank">ThemeWagon</a> </p>
    </div>
  </footer>
</template>
<script>
